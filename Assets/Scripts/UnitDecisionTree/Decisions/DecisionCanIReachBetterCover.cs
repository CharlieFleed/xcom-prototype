...
public class DecisionCanIReachBetterCover : Decision
{
    Unit _unit;
    ...
    public DecisionCanIReachBetterCover(Unit unit, List<GridNode> coverPositions, DecisionTreeNode trueNode, DecisionTreeNode falseNode) :
