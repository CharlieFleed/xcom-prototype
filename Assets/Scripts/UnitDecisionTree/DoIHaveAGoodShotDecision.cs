...
public class DoIHaveAGoodShotDecision : Decision
{
    Shooter _shooter;
    List<ShotStats> _shots;

    public DoIHaveAGoodShotDecision(Shooter shooter, List<ShotStats> shots, DecisionTreeNode trueNode, DecisionTreeNode falseNode) :
